...
<Image
  ...
  alt="AI-generated illustration: a father explaining artificial intelligence to his two young children"
  width={800}
  height={600}
  className="rounded-xl mx-auto my-6 shadow-md"
/>

<p className="text-center text-sm text-brun-lighter italic -mt-4 mb-6">An image made with AI. More or less how it went.</p>
...
At this age, the brain doesn't learn by receiving an explanation. It learns by touching, sorting, questioning. That evening, Romane hadn't been given a lesson about AI. She had built one.

At the end, Romane asked: *"Can we do it again tomorrow?"*

## What this blog is, and what it isn't

It's not a teaching guide. I'm a father who thinks the topic matters and believes kids are capable (far more capable than we imagine) of grasping the core ideas, as long as we present them differently than with slides and definitions.
