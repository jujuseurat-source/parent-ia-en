...
This process is called training by backpropagation, but the idea is simple: every mistake contains information about how to improve. The error isn't the problem. It's the raw material for learning.

What's striking is the number of tries. A child learns to aim in a few dozen attempts. An AI might need millions of examples to learn to recognise a cat. What's fast for humans is slow for machines, and the other way around.
...
Most children answer intuitively: I threw too hard, too far left, aimed too high. Those are pieces of information about the error. And that's exactly what you give an AI when you correct it.
...
Romane had a strategy. She threw softly on the first go to get a reference point, then adjusted progressively. She said it was *"like learning to ride a bike but longer"*, which struck me as a pretty good description of gradient descent.
