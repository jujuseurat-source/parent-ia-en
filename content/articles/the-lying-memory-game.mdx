...
<Image
  ...
  alt="The Dijon owl, worn smooth by centuries of rubbing, barely recognizable in the stone"
  width={600}
  height={800}
  className="rounded-xl mx-auto my-6 shadow-md"
/>

<p className="text-center text-sm text-brun-lighter italic -mt-4 mb-6">The real owl. No feathers, no eyes. Just a hollow shape carved into stone.</p>
...
Memories don't all get stored the same way. At this age, it's the body that remembers first. The sensory detail, not the visual shape. Not because Meryl wasn't paying attention. Because his brain was working exactly as it should.
